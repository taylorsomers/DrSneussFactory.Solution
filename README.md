...
## Specifications
  ...
  | When the "Remove Machine License" button for a Machine in the Engineers/Details view is clicked, program will display an Engineers/RemoveMachine view with a message confirming the user would like to remove the Engineer's license for that specific Machine. | "Engineer Details / Engineer Name: Jimbo / Jimbo's Machine Licenses: / Buzz Drill / [Button: 'Remove Machine License']" > *Click* | "Confirm removal of license for this machine from Jimbo: / Buzz Drill / [Button: 'Remove Machine License']; [Button: 'Cancel']" |  |
